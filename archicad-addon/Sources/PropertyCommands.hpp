...
class SetPropertyValuesOfElementsCommand : public CommandBase
{
public:
...
class GetPropertyValuesOfAttributesCommand : public CommandBase
{
public:
...
class SetPropertyValuesOfAttributesCommand : public CommandBase
{
public:
...
class DeletePropertyGroupsCommand : public CommandBase
{
public:
...
class CreatePropertyDefinitionsCommand : public CommandBase
{
public:
...
class DeletePropertyDefinitionsCommand : public CommandBase
{
public:
...
class ImportPropertyDefinitionsCommand : public CommandBase
{
public:
    ImportPropertyDefinitionsCommand ();
    virtual GS::String GetName () const override;
    virtual GS::Optional<GS::UniString> GetInputParametersSchema () const override;
    virtual GS::Optional<GS::UniString> GetResponseSchema () const override;
    virtual GS::ObjectState Execute (const GS::ObjectState& parameters, GS::ProcessControl& processControl) const override;
